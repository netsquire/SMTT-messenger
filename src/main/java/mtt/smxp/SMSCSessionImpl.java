...
public class SMSCSessionImpl extends SmppObject implements SMSCSession {
	...
	/**
	 * Initializes the session with the connection the session
	 ...
	 * Note that it can take some time before the thread is completely
	 * stopped.
	 * @see #run()
	 */
	public void stop() {
	 ...
	 * so no extra tidy-up routines are necessary.
	 * @see #stop()
	...
	public void setPDUProcessorFactory(PDUProcessorFactory pduProcessorFactory) {
		// Ignore, the pdu processor is created by listener
	}
