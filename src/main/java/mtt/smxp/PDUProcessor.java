 ...
 * defines the behavior of the particular simulator.<br>
 * The implementations of this class are meant to be generated by
 * descendant of <code>PDUProcessorFactory</code> class whenever
...
public abstract class PDUProcessor {
	...
	/**
	 * Private variables initializes to default values.
	 */
	public PDUProcessor() {
	}

	/**
	 * Initializes the processor with the given group.
	 * The group is basically intended to be a group of active
	 * processors.
